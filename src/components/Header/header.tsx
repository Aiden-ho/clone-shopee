    ...
    <header>
      <div className='py-2 bg-[linear-gradient(-180deg,#f53d2d,#f63)]'>
        <div className='container'>
          <NavHeader />
          <div className='grid grid-cols-4 md:grid-cols-8 lg:grid-cols-12 gap-4 mt-6 items-end'>
            {/* logo */}
            <div className='col-span-4 md:col-span-8 lg:col-span-2'>
              <Link to='/' className='flex items-center gap-3'>
                {/* <svg viewBox='0 0 192 65' className='h-9 md:h-12 fill-white'>
                  <g fillRule='evenodd'>
                ...
                <svg
                  ...
                  viewBox='0 0 32 32'
                  xmlSpace='preserve'
                  className='h-9 md:h-12 fill-white'
                >
                  <g>
                    <path
                ...
                <span className='text-white text-2xl'>ShopeeClone</span>
              </Link>
            </div>
            {/* search */}
            <div className='col-span-3 md:col-span-7 flex flex-col'>
              <form className='bg-white flex items-center justify-between p-1 rounded-sm' onSubmit={handleSubmitSearch}>
                <input
                  type='text'
                  placeholder='Nhập tên sản phẩm'
                  className='border-none outline-none bg-transparent text-xs md:text-sm text-black flex-shrink-0 flex-grow px-3'
          ...
          <div className='grid grid-cols-12 gap-4 text-xs text-gray-100 mt-2 min-h-[1rem]'>
            <div className='col-span-8 col-start-1 md:col-start-1 lg:col-start-3 flex flex-row gap-4'>
              {historySearch &&
