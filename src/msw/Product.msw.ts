...
const prodctDetail = {
  ...
  data: {
    ...
    updatedAt: '2023-12-26T07:01:57.977Z'
  }
}
...
const getDetailRequest = http.get(getBaseURL(`${URL_PRODUCT}/60afb2c76ef5b902180aacba`), () => {
  return HttpResponse.json(prodctDetail, { status: HttpStatusCode.Ok })
})

const productRequests = [getRequest, getDetailRequest]
