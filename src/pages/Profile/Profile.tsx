      ...
      <div className='flex flex-col-reverse md:flex-row md:items-start gap-8'>
        <form className='py-7 flex-grow'>
          ...
          <div className='flex items-center flex-wrap justify-center'>
            ...
            <div className='w-[80%]'>
              <Button className='bg-orange px-6 py-3 text-white rounded-sm hover:bg-orange/90'>Lưu</Button>
            </div>
          </div>
        </form>
        <div className='md:w-80 py-7'>
          <div className='border-l-[1px] w-full flex flex-col justify-center items-center gap-3'>
            ...
            <Button className='border border-gray-300 hover:bg-gray-100 px-4 py-2 text-sm text-gray-500 rounded-sm'>
              Chọn Ảnh
            </Button>
